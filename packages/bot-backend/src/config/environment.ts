...
const _optionalEnvVars: EnvVar[] = [
	...
	{ name: 'PORT', type: 'number', description: 'Server Port', default: 3000 },
	{
		...
		type: 'string',
		description: 'CORS Alowed Origins',
	},
	{
	...
	{
		name: 'MAX_TASKS_PER_COMMAND',
		type: 'number',
		description: 'Max tasks per command',
		default: 5,
	},
	{
		name: 'RATE_LIMIT_DEFAULT_MAX',
		type: 'number',
		description: 'Rate limit default max requests',
		default: 5,
	},
	{
		name: 'RATE_LIMIT_DEFAULT_WINDOW',
		type: 'number',
		description: 'Rate limit default window ms',
		default: 10000,
	},
	{
		name: 'RATE_LIMIT_HEAVY_MAX',
		type: 'number',
		description: 'Rate limit heavy max requests',
		default: 2,
	},
	{
		name: 'RATE_LIMIT_HEAVY_WINDOW',
		type: 'number',
		description: 'Rate limit heavy window ms',
		default: 30000,
	},
	{
